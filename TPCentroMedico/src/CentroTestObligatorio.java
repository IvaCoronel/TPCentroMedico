...
public class CentroTestObligatorio {
	...
	private Centro ctro;
		...
		public void setUp() throws Exception {
			...
			ctro.agregarMedico("Rene Vena", 12345, "Cardiologia", 2000);
			ctro.agregarMedico("Susana Cortez", 34567, "Dermatologia", 1500);
			ctro.agregarMedico("Mario Piazza", 56789, "Pediatria", 1200);
			...
			ctro.agregarPacienteObraSocial("Damian Moreno", 432, new Fecha(1,5,1963),"Osplad", 0.2);
...
*
		...
		public void testListaInternacion() { 
			...
			ctro.agregarPacienteObraSocial("Ramiro Delgado", 765, new Fecha(9,7,1989),"Osde", 0.1);
